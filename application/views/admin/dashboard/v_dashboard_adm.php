<main id="main" class="main">
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('dashboard.html') ?>">Home</a></li>
                ...
                <table class="table table-borderless">
                  ...
                  <tbody>
                    <?php foreach ($OP as $row) : ?>
                      <tr>
                        <th scope="row"><?php echo $row['ORG']; ?></th>
                        <td><a href="#" class="text-primary fw-bold"><?php echo $row['TAHUN']; ?></a></td>
                        <td><?php echo $row['JUMLAH_TRX']; ?></td>
                        <td class="fw-bold"><?php echo 'Rp ' . number_format($row['TOTAL_FEE_OPR']); ?>,-</td>
                        <td>
                          <?php if ($row['STATUS'] == 'S') {
                            echo "Success";
                          }  ?>
