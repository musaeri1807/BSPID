...
<body>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="<?php echo base_url('dashboard.html'); ?>" class="logo d-flex align-items-center w-auto">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="<?= base_url('authadmin/login.html'); ?>" method="POST" novalidate>
                                        ...
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Pengguna</label>
                                            <div class="input-group has-validation">
                                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                <input type="text" name="username" class="form-control" id="yourUsername" value="info@miga.co.id" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="password" class="form-control" id="yourPassword" value="P@ssw0rd" required>
                                        ...
                                        <div class="col-12">
                                            <!-- <a href="" class="btn btn-primary w-100">Masuk</a> -->

                                            <button class="btn btn-primary w-100" type="submit">Masuk</button>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">Tidak punya akun? | Klik <a href="pages-register.html">Buat sebuah akun</a></p>
                                            <p class="small mb-0">Jika Kehilangan Akses| Klik <a href="pages-register.html">Lupa kata sandi</a></p>
                                        </div>
                                    </form>
    ...
    <script src="<?php echo base_url(); ?>assets_admin/vendor/quill/quill.min.js"></script>
