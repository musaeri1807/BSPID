    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="<?php echo base_url('Frontend/tentangkami'); ?>" class="nav-item nav-link active">Tentang Kami</a>
        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    ...
                    <p class="mb-4">
                        Dalam menjalankan aktivitasnya, PT ANTAM Tbk UBPP Logam Mulia berkomitmen untuk tidak sekadar memprioritaskan profit, namun juga benefit yang dapat dinikmati oleh lingkungan dan masyarakat sekitar
                        Mempertimbangkan domisili perusahaan yang berada di ibukota, perusahaan berusaha untuk memberikan kontribusi terutama menyangkut permasalahan yang kerap kita temukan dalam kehidupan sehari-hari masyarakat kota besar, salah satunya adalah sampah. <br>
                        Persoalan sampah di ibukota oleh banyak pihak dinilai telah memasuki fase darurat. <br>
                        Sementara itu, penanganan sampah yang dilakukan saat ini belum memberikan hasil yang diinginkan.<br>
                        Sebaliknya, metoda penanganan sampah yang diberlakukan pada faktanya tetap menyisakan masalah serius.<br>
                        Oleh karena itu diperlukan upaya alternatif sebagai solusinya, yaitu dengan memberdayakan masyarakat melalui Program Bank Sampah Pintar.
