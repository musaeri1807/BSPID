            ...
            <div class="col-md-6">
                <div class="bg-secondary bg-fruit d-flex flex-column justify-content-center p-5" style="height: 150px;">
                    ...
                    <!-- <p class="text-white">Dolor magna ipsum elitr sea erat elitr amet ipsum stet justo dolor, amet
                            lorem diam no duo sed dolore amet diam</p> -->
                    <!-- <a class="text-white fw-bold" href="">Read More<i class="bi bi-arrow-right ms-2"></i></a> -->
                    <a href="<?php echo base_url('Frontend/unit') ?>" class="btn btn-primary py-md-3 px-md-5 me-3">Daftar Unit </a>
                </div>
            </div>
        </div>
    </div>
...
<table hidden>
    ...
    <tr>
        <td>Bobot Sampah</td>
        <td><?php echo $bobotP = $TT->TOTALSAMPAH; ?></td>
        <td><?php echo $bobotK = $TT->TOTALSAMPAH; ?></td>
        <td>Kg</td>
    </tr>
    <tr>
        <?php $SW = 1000000; ?>
...
<table hidden>
    ...
    <tr>
        ...
        <td> <?php echo $resultCO2eq = $CO2eq * 1000; ?></td> <!--Ton-CO2-eq-->
    </tr>
</table>
<!--PARAMETER -->
<!-- Facts Start -->
    ...
    <div class="container py-5">
        <div class="row gx-5 gy-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    <div class="bg-secondary rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                        <i class="fa fa-cheese fs-4 text-white"></i>
                    </div>
                    <div class="ps-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    <div class="bg-secondary rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                        <i class="fa fa-beer -mug fs-4 text-white"></i>
                    </div>
                    <div class="ps-4">
                        <h5 class="text-white">Ton-CO2-eq</h5>
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up"><?php echo round($resultCO2eq, 2); ?></h1>
                    </div>
                </div>
            </div>
        </div>
