...
function sendmailverifikasi($nama, $email, $content, $password, $tokenn, $button)
{
                                  ...
                                  <tr>
                                      <td class="content-cell">
                                          ...
                                          <p>
                                              ...
                                              Untuk mengaktifkan akun anda silakan klik tombol dibawah :
                                          </p>
                                          <!-- Action -->
                                          <table class="body-action" align="left" width="100%" cellpadding="0"
                                              cellspacing="0">
                                                          ...
                                                          <tr>
                                                              <td align="center">
                                                                  <table border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                          <td>
                                                                              <a href="' . base_url() . 'auth/verifikasi?email=' . $email . '&token=' . urlencode($tokenn) . '" class="button button--green"
                                                                                  target="' . base_url() . 'auth/verifikasi?email=' . $email . '&token=' . urlencode($tokenn) . '">' . $button . '</a>
                                                                          </td>
                                                                      </tr>
                                                                  </table>
                                                              </td>
